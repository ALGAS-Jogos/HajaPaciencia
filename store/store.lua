...
function loadStoreItems()
    local obj={
        ...
        {name="Deep Blue",bought=false,price=500,fontName="fonts/RussoOne.ttf",font="fonts/RussoOne.ttf",color={0.231, 0, 0.388},textcolor={0.9,0.9,0.9},suitcolor={0.9,0.9,0.9},casered={1,0.1,0.1}},
