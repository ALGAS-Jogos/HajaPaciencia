...
function loadStoreItems()
    local obj={
        ...
        {name="Rustic",bought=false,price=500,font="fonts/Caprasimo.ttf",color={1, 0.996, 0.863},textcolor={0.01,0.01,0.01},suitcolor={0.01,0.01,0.01},casered={0.612, 0, 0}},
        {name="Deep Blue",bought=false,price=500,font="fonts/RussoOne.ttf",color={0.231, 0, 0.388},textcolor={0.9,0.9,0.9},suitcolor={0.9,0.9,0.9},casered={1,0.1,0.1}},
        ...
        {name="Silvery",bought=false,price=500,font="fonts/BlackOpsOne.ttf",color={0.05,0.05,0.05},textcolor={0.859, 0.859, 0.859},suitcolor={0.859, 0.859, 0.859},casered={1,0.25,0.25}},
...
function loadStoreBacks()
    local obj = {
        ...
        {name="Forest",price=250,bought=false,font="fonts/Outfit.ttf",img=love.graphics.newImage("backgrounds/back2.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}},
        {name="Woodboard",price=300,bought=false,font="fonts/AlfaSlabOne.ttf",img=love.graphics.newImage("backgrounds/back3.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}},
        {name="Waterfall",price=250,bought=false,font="fonts/Bricolage.ttf",img=love.graphics.newImage("backgrounds/back4.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}},
        {name="Foggy Mountains",price=450,bought=false,font="fonts/Bricolage.ttf",img=love.graphics.newImage("backgrounds/back5.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}},
        {name="Starry night",price=350,bought=false,font="fonts/Tektur.ttf",img=love.graphics.newImage("backgrounds/back6.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}},
        {name="Sunrise",price=450,bought=false,font="fonts/Outfit.ttf",img=love.graphics.newImage("backgrounds/back7.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}},
        ...
        {name="Forest Sky",price=450,bought=false,font="fonts/Bricolage.ttf",img=love.graphics.newImage("backgrounds/back9.jpg"),color={0.05,0.05,0.05},textcolor={1,1,1}}
    }
    return obj
end
